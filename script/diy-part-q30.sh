...
sed -i 's/ImmortalWrt/JCG Q30 Pro/g' package/base-files/files/bin/config_generate

# 修改开源驱动wifi名称
#sed -i 's/OpenWrt/R30B1_AX3000/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh

# 修改闭源驱动2G wifi名称
sed -i 's/MT7981_AX3000_2.4G/Q30/g' package/mtk/drivers/wifi-profile/files/mt7981/mt7981.dbdc.b0.dat
...
# 修改闭源驱动5G wifi名称
sed -i 's/MT7981_AX3000_5G/Q30/g' package/mtk/drivers/wifi-profile/files/mt7981/mt7981.dbdc.b1.dat
